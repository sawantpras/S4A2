public class TestShirt {
	...
	public static void main(String[] args) {
		...
		System.out.println("2. Disply using first object overloaded constructor");
		s1.displayShirtDetails();

		// using overloaded constructor display
		System.out.println("3. Disply using second object overloaded constructor");
		...
		System.out.println("shirt collar size is  " + s3.getShirt_collar_size());
		System.out.println("shirt sleeve size is  " + s3.getShirt_sleeve_length());
